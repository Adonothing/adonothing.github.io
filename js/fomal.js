...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | Adunas🍀")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'VUMBZ-7KDCW-JMLRD-3SDV4-6DOM2-KFBI7',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function createtime1() {
  ...
  var ascll = [
    `欢迎来到Adunas🍀の异世界!`,
    `We are together and never give up ! 🍭🍭🍭`,
    `
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Adunas🍀 %c 你正在访问Adunas🍀の异世界",
...
l = ["好消息，日本没了！", "美国垮了，原因竟然是川普再次上任了！", "微软垮了！","非常抱歉，因为不可控原因，博客将于明天停止运营！", "你的设备已经中毒，请立即关机，快！", "你的设备已经被监控，请立刻删除不良内容，否则我将公之于众！", "你已经被监视，有危险！现在请立刻站起来！","你知道吗？我已经喜欢你很久了！", "你知道吗？我真的很喜欢你！","你知道吗？我真的很喜欢你！一直不敢和你说，你能答应我吗？","你知道吗？上次不是拒绝你，而是喜欢得害怕，你能再说一次嘛，再说一次我就答应你！","离谱！我今天中了一百万，我现在只告诉你了一个人，我们一起分享", "疑神疑鬼？你真以为是空穴来风？你喜欢的人已经跟别人跑了！", "明天你喜欢的人就要和我结婚了，你能来现场给我们祝福吗？"]
...
function createtime() {
  ...
  // (currentTimeHtml =
  //   hnum < 18 && hnum >= 9
  //     ? `<img class='boardsign' src='https://lskypro.acozycotage.net/Fomalhaut/badge/F小屋-科研摸鱼中.svg' title='上班时间认真干活啦~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
  //     : `<img class='boardsign' src='https://lskypro.acozycotage.net/Fomalhaut/badge/F小屋-下班休息啦.svg' title='下班时间开心玩耍啦~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
  ...
  var loop = function () {
    ...
    if (now > 1000 + lastTime) {
      ...
      if (fps <= 5) {
        ...
        var kd = `<span style="color:#39c5bb">十分流畅o((>ω<))o</span>`
      }
...
<p id="swfs">
<a class="swf" id="swf_TTQHB" href="javascript:;" rel="noopener external nofollow" style="font-family:'TTQHB'!important;color:black" onclick="setFont('TTQHB')">默认字体</a>
<a class="swf" id="swf_TSZQGBJ" href="javascript:;" rel="noopener external nofollow" style="font-family:'TSZQGBJ'!important;color:black" onclick="setFont('TSZQGBJ')">腾祥铚谦钢笔简</a>
<a class="swf" id="swf_PAYBJ" href="javascript:;" rel="noopener external nofollow" style="font-family:'PAYBJ'!important;color:black" onclick="setFont('PAYBJ')">佩安硬笔简</a>
<a class="swf" id="swf_default" href="javascript:;" rel="noopener external nofollow" style="font-family:-apple-system, IBM Plex Mono ,monosapce,'微软雅黑', sans-serif;!important;color:black" onclick="setFont('default')">Hexo默认字体</a>
</p>
